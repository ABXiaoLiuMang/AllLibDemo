...
public class MyBitmapTransformation extends BitmapTransformation {
    ...
    public MyBitmapTransformation(int dpRadius, int marginDp) {
        this(dpRadius, marginDp, CornerType.ALL, ScaleType.FIT_CENTER);
    }

    public MyBitmapTransformation(int dpRadius, int marginDp, CornerType cornerType, ScaleType scaleType) {
    ...
    public boolean equals(Object o) {
        return o instanceof MyBitmapTransformation &&
                ((MyBitmapTransformation) o).radius == radius &&
                ((MyBitmapTransformation) o).diameter == diameter &&
                ((MyBitmapTransformation) o).margin == margin &&
                ((MyBitmapTransformation) o).cornerType == cornerType;
    }
