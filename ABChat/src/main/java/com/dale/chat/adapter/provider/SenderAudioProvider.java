...
public class SenderAudioProvider extends BaseProvider<MultipleMsgEntity, BaseViewHolder> {

    @Override
    public int viewType() {
        return MultipleMsgEntity.SENDER_AUDIO;
    }

    @Override
    public int layout() {
        return R.layout.sender_item_audio_layout;
    }
    ...
    public void convert(BaseViewHolder helper, MultipleMsgEntity data, int position) {
        ...
        RelativeLayout wechat_receiver_audio = helper.getView(R.id.wechat_sender_audio);
