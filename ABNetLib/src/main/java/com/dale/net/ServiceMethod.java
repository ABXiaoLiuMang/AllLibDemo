    ...
    static final class Builder<T, R> {
        ...
        private void parseMethodAnnotation(Annotation annotation) {
            if (annotation instanceof GET) {
                parseHttpMethodAndPath(Constant.GET,((GET) annotation).value());
            } else if (annotation instanceof POST) {
                parseHttpMethodAndPath(Constant.POST,((POST) annotation).value());
            }else if (annotation instanceof DELETE){
                parseHttpMethodAndPath(Constant.DELETE,((DELETE) annotation).value());
            }else if (annotation instanceof PUT){
                parseHttpMethodAndPath(Constant.PUT,((PUT) annotation).value());
            }else if (annotation instanceof HEAD){
                parseHttpMethodAndPath(Constant.HEAD,((HEAD) annotation).value());
            }else if (annotation instanceof PATCH){
                parseHttpMethodAndPath(Constant.PATCH,((PATCH) annotation).value());
            }
        }
