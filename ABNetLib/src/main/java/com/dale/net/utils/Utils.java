...
public final class Utils {
    ...
    public static String convertGetParams(Map<String, String> paramsMap) {
        ...
        try {
            ...
            for (Map.Entry<String, String> entry:paramsMap.entrySet()){
                ...
                temParams.append(String.format("%s=%s",entry.getKey(), URLEncoder.encode(entry.getValue(),"UTF-8")));
                pos++;
            }
        }catch (Exception e){
        }
        return temParams.toString();
    }
}
