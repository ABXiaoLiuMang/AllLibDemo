...
public class FullScreenPopupView extends CenterPopupView {
    ...
    protected void applySize(boolean isShowNavBar) {
        ...
        int actualNabBarHeight = isShowNavBar||XPopupUtils.isNavBarVisible(getContext()) ? StatusBarUtil.getNavBarHeight() : 0;
        if (rotation == 0) {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (popupInfo.hasStatusBarShadow) {
            ...
            shadowRect = new Rect(0, 0, ScreenUtils.getScreenWidth(), StatusBarUtil.getStatusBarHeight(getContext()));
