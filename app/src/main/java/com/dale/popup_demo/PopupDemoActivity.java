...
public class PopupDemoActivity extends AppCompatActivity {
    ...
    public void showMultiPopup(){
        ...
        loadingPopup.show();
        new XPopup.Builder(PopupDemoActivity.this)
                .autoDismiss(false)
                .asBottomList("haha", new String[]{"点我显示弹窗", "点我显示弹窗", "点我显示弹窗", "点我显示弹窗"}, new OnSelectListener() {
                    @Override
                    public void onSelect(int position, String text) {
                        new XPopup.Builder(PopupDemoActivity.this).asConfirm("测试", "aaaa", new OnConfirmListener() {
                            @Override
