...
import com.dale.popup_demo.MainActivity;
...
import com.dale.popup_demo.custom.ListDrawerPopupView;
            ...
            case R.id.btnShowInBackground:
                ...
                XPopup.requestOverlayPermission(getContext(), new XPermission.SimpleCallback() {
                    ...
                    public void onGranted() {
                        ToastUtils.showLong("等待2秒后弹出XPopup！！！");
                    ...
                    public void onDenied() {
                        ToastUtils.showLong("权限拒绝需要申请悬浮窗权限！");
                    }
                });
                break;
        }
