...
import com.dale.pickerviewlib.builder.TimePickerBuilder;
import com.dale.pickerviewlib.view.CityPickerView;
import com.dale.pickerviewlib.view.TimePickerView;
import com.dale.popup_demo.custom.CustomAttachPopup;
import com.dale.popup_demo.custom.CustomAttachPopup2;
import com.dale.popup_demo.custom.CustomDrawerPopupView;
import com.dale.popup_demo.custom.CustomEditTextBottomPopup;
import com.dale.popup_demo.custom.CustomFullScreenPopup;
import com.dale.popup_demo.custom.PagerBottomPopup;
import com.dale.popup_demo.custom.PagerDrawerPopup;
import com.dale.popup_demo.custom.QQMsgPopup;
import com.dale.popup_demo.custom.ZhihuCommentPopup;
import com.dale.utils.TimeUtils;
...
//                        .hasShadowBg(false)
                        ...
                        .asCustom(new PagerDrawerPopup(getContext()))  //2

//                        .asCustom(new ListDrawerPopupView(getContext()))//3
                        .show();
                break;
...
//                        .popupPosition(PopupPosition.Right) //手动指定位置，有可能被遮盖
    ...
    private void showDatePickerDialog() {
        ...
        if (timeStartPickerView == null) {
            ...
            timeStartPickerView = new TimePickerBuilder(getActivity(), (date, v) -> {
                ToastUtils.showLong( TimeUtils.DATE_FORMAT_DATE.format(date));
            }).setSubmitText("确定")
                    .setCancelText("取消")
                    .setDate(calendar)
                    .setTitleText("选择开始日期")
    ...
    private void showCityPickerDialog(){
        if(cityPickerView == null){
            cityPickerView =  new CityPickerView(getActivity(),"四川");
            cityPickerView.setOnCitySelectListener((prov, city, area) -> {
                ToastUtils.showLong("prov:" + prov +"  city:"+city +"  area:"+ area);
            });
        }
        cityPickerView.show();
    }
