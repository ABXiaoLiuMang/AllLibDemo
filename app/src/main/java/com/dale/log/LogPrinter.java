...
final class LogPrinter implements ILogPrinter {
  ...
  private final LogConfig settings = new LogConfig();
  ...
  @Override
  public LogConfig init(String tag) {
    if (tag == null) {
  ...
  @Override
  public LogConfig getSettings() {
    return settings;
  }

  @Override
  public ILogPrinter t(String tag, int methodCount) {
    if (tag != null) {
      localTag.set(tag);
    }
