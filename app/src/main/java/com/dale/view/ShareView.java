...
public class ShareView extends HorizontalScrollView {
    ...
    protected void onFinishInflate() {
        ...
        mDragShareView = findViewById(R.id.mDragShareView);
    ...
    public void refreshImageLayout(){
        mDragShareView.refreshImageLayout();
    }
    ...
    public void setUrl(String url) {
        ...
        Glide.with(getContext()).asBitmap().load(url).into(new SimpleTarget<Bitmap>() {
            ...
            public void onResourceReady(Bitmap resource, Transition<? super Bitmap> transition) {
                ...
                mDragShareView.setLayoutParams(layoutParams);
