...
public class ScrollChangeHelper implements NestedScrollView.OnScrollChangeListener {
    ...
    public ScrollChangeHelper(ScrollChangeHelper.Builder builder) {
        init(builder);
    }

    void init(ScrollChangeHelper.Builder builder) {
    ...
    public static class Builder {
        ...
        public ScrollChangeHelper.Builder scrollHeight(int scrollHeight) {
            this.scrollHeight = scrollHeight;
            return this;
        }

        public ScrollChangeHelper.Builder setNestedScrollView(NestedScrollView scrollView) {
            this.scrollView = scrollView;
            return this;
        }

        public ScrollChangeHelper.Builder setAlphaView(View alphaView) {
            this.alphaView = alphaView;
            return this;
        }

        public ScrollChangeHelper.Builder setOnMoveRatioListener(onMoveRatioListener onMoveRatioListener) {
