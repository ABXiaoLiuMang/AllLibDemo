...
/**
 * 横向切割标签分类选项卡
 * 原文地址:https://github.com/Dsiner/UIUtil/blob/master/lib_ui/src/main/java/com/d/lib/common/view/SegmentView.java
 */
public class SegmentView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mStrTitles = typedArray.getString(R.styleable.SegmentView_segmentv_titles);
        mColorA = typedArray.getColor(R.styleable.SegmentView_segmentv_colorMain, ContextCompat.getColor(context, android.R.color.background_dark));
        mColorB = typedArray.getColor(R.styleable.SegmentView_segmentv_colorSub, ContextCompat.getColor(context, android.R.color.holo_red_dark));
        mTextSize = typedArray.getDimension(R.styleable.SegmentView_segmentv_textSize, SizeUtils.dp2px(14));
        mRectRadius = typedArray.getDimension(R.styleable.SegmentView_segmentv_radius, -1);
        mDivideWidth = typedArray.getDimension(R.styleable.SegmentView_segmentv_divideWidth, SizeUtils.dp2px(1));
        mPadding = typedArray.getDimension(R.styleable.SegmentView_segmentv_borderWidth, SizeUtils.dp2px(1));
        typedArray.recycle();
    }
