...
public class RoundImageView extends AppCompatImageView {
    ...
    protected void initAttrs(AttributeSet attrs) {
        if (attrs != null) {
            ...
            borderWidth = ta.getDimension(R.styleable.RoundImageView_border_width, 0);
            borderColor = ta.getColor(R.styleable.RoundImageView_border_color, 0);
            ...
            float radius = ta.getDimension(R.styleable.RoundImageView_radius, 15);
            if (radius != 0) {
