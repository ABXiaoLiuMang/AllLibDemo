...
public class PassWordEditText extends AppCompatEditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    public void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            hideImage = typedArray.getResourceId(R.styleable.PassWordEditText_hideDrawable, R.drawable.eye_close3x);
            showImage = typedArray.getResourceId(R.styleable.PassWordEditText_showDrawable, R.drawable.eye_open3x);
            typedArray.recycle();
        } else {
